...
def get_equity(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    지분증권 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_equity(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
...
def get_debt(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    채무증권 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_debt(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
...
def get_depository_receipt(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    증권예탁증권 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_depository_receipt(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
...
def get_merger_report(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    합병 증권신고서 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_merger_report(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
...
def get_stock_exchange_report(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_stock_exchange_report(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
...
def get_division_report(ctx: Context[OpenDartContext, Any], corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    분할 증권신고서 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds006.get_division_report(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    ))
