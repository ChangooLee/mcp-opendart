...
def get_major_holder_changes(ctx: Context[OpenDartContext, Any], corp_code: str, start_date: Optional[str] = None, end_date: Optional[str] = None) -> Dict[str, Any]:
    """
    대량보유 상황보고 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds004.get_major_holder_changes(
        corp_code=corp_code,
...
def get_executive_trading(ctx: Context[OpenDartContext, Any], corp_code: str, start_date: Optional[str] = None, end_date: Optional[str] = None) -> Dict[str, Any]:
    """
    임원ㆍ주요주주 소유보고 조회
    ...
    """
    return cast(Dict[str, Any], ctx.request_context.lifespan_context.ds004.get_executive_trading(
        corp_code=corp_code,
        start_date=start_date,
        end_date=end_date
    ))
