...
def get_asset_transfer(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    자산양수도(기타), 풋백옵션 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_asset_transfer(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_bankruptcy(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    부도발생 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_bankruptcy(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_business_suspension(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    영업정지 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_business_suspension(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_rehabilitation(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    회생절차 개시신청 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_rehabilitation(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_dissolution(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    해산사유 발생 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_dissolution(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_paid_in_capital_increase(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    유상증자 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_paid_in_capital_increase(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_free_capital_increase(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    무상증자 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_free_capital_increase(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_paid_free_capital_increase(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    유무상증자 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_paid_free_capital_increase(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_capital_reduction(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    감자 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_capital_reduction(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_creditor_management(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    채권은행 등의 관리절차 개시 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_creditor_management(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_lawsuit(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    소송 등의 제기 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_lawsuit(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_foreign_listing_decision(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_foreign_listing_decision(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_foreign_delisting_decision(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_foreign_delisting_decision(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_foreign_listing(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    해외 증권시장 주권등 상장 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_foreign_listing(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_foreign_delisting(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    해외 증권시장 주권등 상장폐지 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_foreign_delisting(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_convertible_bond(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    전환사채권 발행결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_convertible_bond(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_bond_with_warrant(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    신주인수권부사채권 발행결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_bond_with_warrant(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_exchangeable_bond(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    교환사채권 발행결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_exchangeable_bond(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_creditor_management_termination(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    채권은행 등의 관리절차 중단 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_creditor_management_termination(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_write_down_bond(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    상각형 조건부자본증권 발행결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_write_down_bond(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_treasury_stock_acquisition(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    자기주식 취득 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_treasury_stock_acquisition(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_treasury_stock_disposal(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    자기주식 처분 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_treasury_stock_disposal(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_treasury_stock_trust_contract(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_treasury_stock_trust_contract(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_treasury_stock_trust_termination(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_treasury_stock_trust_termination(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_business_acquisition(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    영업양도 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_business_acquisition(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_tangible_asset_transfer(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    유형자산 양수 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_tangible_asset_transfer(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_tangible_asset_acquisition(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    유형자산 양도 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_tangible_asset_acquisition(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_other_corp_stock_transfer(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_other_corp_stock_transfer(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_other_corp_stock_acquisition(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_other_corp_stock_acquisition(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_stock_related_bond_transfer(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    주권 관련 사채권 양수 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_stock_related_bond_transfer(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_stock_related_bond_acquisition(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    주권 관련 사채권 양도 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_stock_related_bond_acquisition(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_merger(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    회사합병 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_merger(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_division(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    회사분할 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_division(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_division_merger(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    회사분할합병 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_division_merger(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
...
def get_stock_exchange(ctx: Context, corp_code: str, bgn_de: str, end_de: str) -> Dict[str, Any]:
    """
    주식교환·이전 결정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds005.get_stock_exchange(
        corp_code=corp_code,
        bgn_de=bgn_de,
        end_de=end_de
    )
