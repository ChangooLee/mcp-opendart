...
def get_single_acnt(ctx: Context, corp_code: str, bsns_year: str, reprt_code: str, fs_div: Optional[str] = None) -> Dict[str, Any]:
    """
    단일회사 주요계정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_single_acnt(
        corp_code=corp_code,
        bsns_year=bsns_year,
...
def get_multi_acnt(ctx: Context, corp_code: str, bsns_year: str, reprt_code: str, fs_div: Optional[str] = None) -> Dict[str, Any]:
    """
    다중회사 주요계정 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_multi_acnt(
        corp_code=corp_code,
        bsns_year=bsns_year,
        reprt_code=reprt_code,
        fs_div=fs_div
...
def get_xbrl_file(ctx: Context, rcept_no: str, reprt_code: str) -> Dict[str, Any]:
    """
    재무제표 원본파일(XBRL) 다운로드
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_xbrl_file(
        rcept_no=rcept_no,
        reprt_code=reprt_code
    )
...
def get_single_acc(ctx: Context, corp_code: str, bsns_year: str, reprt_code: str, fs_div: str = "OFS") -> Dict[str, Any]:
    """
    단일회사 전체 재무제표 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_single_acc(
        corp_code=corp_code,
        bsns_year=bsns_year,
        reprt_code=reprt_code,
        fs_div=fs_div
...
def get_xbrl_taxonomy(ctx: Context, sj_div: str, corp_code: Optional[str] = None, bsns_year: Optional[str] = None, reprt_code: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_xbrl_taxonomy(
        sj_div=sj_div,
        corp_code=corp_code,
        bsns_year=bsns_year,
        reprt_code=reprt_code
...
def get_single_index(ctx: Context, corp_code: str, bsns_year: str, reprt_code: str, idx_cl_code: str) -> Dict[str, Any]:
    """
    단일회사 주요 재무지표 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_single_index(
        corp_code=corp_code,
        bsns_year=bsns_year,
        reprt_code=reprt_code,
...
def get_multi_index(ctx: Context, corp_code: str, bsns_year: str, reprt_code: str, idx_cl_code: str) -> Dict[str, Any]:
    """
    다중회사 주요 재무지표 조회
    ...
    """
    return ctx.request_context.lifespan_context.ds003.get_multi_index(
        corp_code=corp_code,
        bsns_year=bsns_year,
        reprt_code=reprt_code,
        idx_cl_code=idx_cl_code
